# Consignes pour Claude Code — Écran d'un protocole (Guide-moi)
...
8. Cadre de sécurité — `protocole.consulter_si` (cadre rouge complet)
...
| Cadre de sécurité | `#EDE9E4` | **complète 1px `#D4604A`** | `#8A3020` |
...
- [ ] Cadre de sécurité : encadré complet fin rouge, coins arrondis sur tout le pourtour.
